        ...
        <div class="col-12 col-lg-10">
            ...
            <div class="card help-card bg-white p-4 mb-4">
                <div class="d-flex align-items-center mb-3">
                    ...
                    <h4 class="fw-bold mb-0 text-dark">Booking a Patient Appointment & Automated SMS Dispatch</h4>
                </div>
                <p class="text-secondary">
                ...
                <ul>
                    ...
                    <li>Click <strong>Confirm & Register Appointment</strong>. Upon registration, the system triggers the <code>NotificationService</code> (Observer/Strategy pattern) to format and deliver an automated SMS alert to the patient.</li>
                </ul>
            </div>
            ...
            <div class="card help-card bg-white p-4 mb-4">
                <div class="d-flex align-items-center mb-3">
                    ...
                    <h4 class="fw-bold mb-0 text-dark">Clinic Management Analytics & Reports (Task B)</h4>
                </div>
                <p class="text-secondary">
